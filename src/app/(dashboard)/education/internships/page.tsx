                ...
                <div key={i.id} className="card-hover p-0 overflow-hidden flex flex-col">
                  ...
                  <div className="p-4 pb-3">
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-3">
                      ...
                      <span className={`text-[10px] px-2 py-0.5 rounded-full font-medium ${i.mode === 'remote' ? 'bg-purple-500/10 text-purple-400' : i.mode === 'hybrid' ? 'bg-indigo-500/10 text-indigo-400' : 'bg-emerald-500/10 text-emerald-400'}`}>
